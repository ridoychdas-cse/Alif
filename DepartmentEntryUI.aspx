<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DepartmentEntryUI.aspx.cs" Inherits="DepartmentEntryUI" %>
--%>
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DepartmentEntryUI.aspx.cs" Inherits="DepartmentEntryUI" %>
 ...
 <tr>
	<td style="vertical-align:middle; height:100%;" align="center">        
       ...
       <asp:Button 
             ...
             <td style="vertical-align:middle; height:100%;" align="center">
                                 <asp:Button ID="SectionSaveButton" runat="server" Text="Save" Width="100px" 
                    onclick="SectionSaveButton_Click" CssClass="buttonclass" /></td>	
	<td style="vertical-align:middle;" align="center">                
      ...
      <asp:Label ID="Label3" runat="server" BackColor="#CCCCCC" Font-Bold="True" 
        ...
        <tr>
            <td align="right" style="height:17px;" class="style1">
                ...
                <asp:TextBox ID="txtFacultyId" runat="server" Enabled="False" Width="98%" SkinID="tbPlain" 
        ...
        <asp:DropDownList SkinID="ddlPlain" ID="ddlCourseName" runat="server" 
            Font-Size="8pt" Width="100%" Height="26px" 
                                            onselectedindexchanged="ddlCollegeName_SelectedIndexChanged">
     </asp:DropDownList>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td align="right" colspan="6" style="height: 28px;">
                                        <asp:GridView ID="dgFaculty" runat="server" AllowPaging="True" 
                                            ...
                                            onpageindexchanging="dgDepartment_PageIndexChanging" 
                                            onrowdatabound="dgDepartment_RowDataBound" 
                                            onselectedindexchanged="dgDepartment_SelectedIndexChanged" PageSize="30" 
                                            Width="100%">
                                            <Columns>
                                                <asp:CommandField ShowSelectButton="True" />
                                                <asp:BoundField DataField="DeptId" HeaderText="ID" />
                                                <asp:BoundField DataField="DeptName" HeaderText="Faculty Name" />
                                                <asp:BoundField DataField="CollegeId" HeaderText="Course Id" />
                                                <asp:BoundField DataField="CollegeName" HeaderText="Course Name" />
                                            </Columns>
                                        </asp:GridView>
                                    </td>
                                </tr>
